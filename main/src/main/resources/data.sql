insert into user (username, password, email,realname,phone_number) values ('admin', '$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi', 'admin@','조행래','010-7638-0028');
...
insert into work_info(user_id, store_id, wage, account, mon_start, mon_end, tue_start, tue_end, wed_start, wed_end, thu_start, thu_end, fri_start, fri_end, sat_start, sat_end, sun_start, sun_end) values (5, 1, 9500, '1111-22222-44444', '10:00', '16:00', null, null, '14:30', '18:00','10:00', '16:00', '09:00', '13:00','09:00', '13:00', null, null);
...
insert into work_info(user_id, store_id, wage, account, mon_start, mon_end, tue_start, tue_end, wed_start, wed_end, thu_start, thu_end, fri_start, fri_end, sat_start, sat_end, sun_start, sun_end) values (7, 1, 9500, '21110-20-14445', null, null, '14:30', '18:00', null, null, '09:00', '13:00', null, null, '09:00', '13:00', '10:00', '16:00');
